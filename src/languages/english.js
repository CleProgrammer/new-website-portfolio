export default function Portuguese() {
    let english = {
        ...
        mainSection: ['Hello, I am Clebson, front-end developer', '<Always striving to evolve and improve each day/>'],
        ...
        projects: ['P R O J E C T S', 'Portfolio Designer', 'Currency Exchange', 'Shopping Website', 'Online Assistant', 'Tic-tac-toe with AI', 'Extension'],
